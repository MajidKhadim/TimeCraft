var date = Date.now();
  ...
  function update_time() {
    ...
    var hours = curr_date.getHours()%12 < 10 ? '0' + curr_date.getHours()%12 : curr_date.getHours()%12;
    var min = curr_date.getMinutes() < 10 ? '0' + curr_date.getMinutes() : curr_date.getMinutes();
    var sec = curr_date.getSeconds() < 10 ? '0' + curr_date.getSeconds() : curr_date.getSeconds();
